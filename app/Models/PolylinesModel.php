...
class PolylinesModel extends Model
{
    ...
    {
        $polylines = $this->select(DB::raw('id, st_asgeojson(geom) as geom, name, description, st_length(geom, true) as length_m, st_length(geom, true)/1000 as length_km, created_at, updated_at, image'))->get();
